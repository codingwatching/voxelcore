...
| `F32view`    | `float`            | 4 байта  |

<small>* Размеры C-шных типов являются платформозависимыми. В данной таблице предоставлены наиболее распространённые размеры типов.</small>
