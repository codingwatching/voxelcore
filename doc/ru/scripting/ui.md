...
| fallback | string | да     | да     | резервная текстура     |
...
| data:mul(*цвет* или Canvas)                              | умножает цвет на указанный цвет или холст                       |
...
| slotIndex | int | да     | нет    | индекс слота, к которому привязан элемент |
